...
/**
 * Serviço responsável pelo cálculo geodésico (Fórmula de Haversine)
 * conforme definido na RFC-0003 (Antifraude e Validação de Integridade).
 */
@Service
public class GeolocalizacaoSrv {
